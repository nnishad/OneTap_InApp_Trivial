...
public final class BillingConstants {
    ...
    public static final String SKU_PREMIUM = "test_product_1";
    public static final String SKU_GAS = "test_product_1";

    // SKU for our subscription (infinite gas)
    public static final String SKU_GOLD_MONTHLY = "test_product_1";
    public static final String SKU_GOLD_YEARLY = "test_product_1";
